...
AUTH0_DOMAIN = os.getenv('AUTH0_DOMAIN', 'huelt.us.auth0.com')
AUTH0_CLIENT_ID = os.getenv('AUTH0_CLIENT_ID', 'K49AQA9fyibCpmTkqUGYq2MQUYeQAgur')
API_AUDIENCE = os.getenv('API_AUDIENCE', 'udacity-capstone')
AUTH0_CALLBACK_URL = os.getenv('AUTH0_CALLBACK_URL', 'http://localhost:8080/login-results')
